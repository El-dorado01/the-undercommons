  ...
  return (
    <section className='w-full pt-14'>
        ...
        <div className='mb-10 max-w-2xl'>
          ...
          <h2 className='text-2xl md:text-3xl font-bold tracking-tight text-foreground mb-6 uppercase'>
            Everything you can barter
          </h2>
          <p className='text-muted-foreground leading-relaxed'>
            Users create posts by selecting a category and listing what they
            need and what they can offer in return.
          </p>
        </div>
          ...
          <div className='lg:col-span-7 pt-2'>
            <AnimatePresence mode='wait'>
              ...
              >
                ...
                <div className='mt-8 w-full h-48 md:h-56 rounded-2xl bg-gray-50 flex items-center justify-center border border-gray-100 relative overflow-hidden group'>
                  <div className='absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] bg-size-[16px_16px] opacity-50' />
                  <activeCategory.icon className='w-20 h-20 text-gray-200 group-hover:scale-110 transition-transform duration-500 ease-out' />
                </div>
              </motion.div>
            </AnimatePresence>
          </div>
